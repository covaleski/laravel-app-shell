...
(A) Add the `make:pwa` command +Console
(A) Add the `make:page` command +Console
...
(A) Make the manifest PHP file optional +Routing {cm:2026-05-17}
(A) Move attributes from `config/pwa.php` +Routing {cm:2026-05-17}
